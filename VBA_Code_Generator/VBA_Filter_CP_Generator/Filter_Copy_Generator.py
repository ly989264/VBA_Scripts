...
# Usage: fill the filter_configuration.json file and run this script
...
# input: source_worksheet name, target_worksheet name, filter(s)
# output: VBA sub with the running purpose of filter-and-copy functionality

with open("filter_configuration.json", "r") as f:
    json_dict = json.load(f)

f = open("VBA_Output.txt", "w")
